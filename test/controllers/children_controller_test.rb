...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post children_url, params: { child: { firstName: @child.firstName, lastName: @child.lastName } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { firstName: @child.firstName, lastName: @child.lastName } }
